...
-Denna CSS-kod är avsedd för input-fältet på registreringssidan (nyhetsbrev) . Det är möjligt att använda annan CSS. Syftet med textfältet är att låta användaren ange sin e-postadress och sedan erhålla en bekräftelse på att fältet har fyllts i korrekt.
